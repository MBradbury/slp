...
def run_simulation(attacker_model):
    ...
    command = "./run.py algorithm.adaptive_spr --mode SINGLE -cm low-asymmetry -nm meyer-heavy -ns 11 -c SourceCorner -safety 50 --source-period 1 --approach PB_FIXED1_APPROACH -am \"{}\" --seed 44".format(
            attacker_model)
