...
class Grenoble(Topology):
    ...
    def __init__(self, subset=None):
        ...
        self.nodes[67] = np.array((10.53, 30.42, 3.6), dtype=np.float64)
        self.nodes[68] = np.array((11.35, 30.27, 3.6), dtype=np.float64)
        ...
        self.nodes[240] = np.array((9.51, 42.8, 3.34), dtype=np.float64)
