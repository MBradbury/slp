...
class Runner:
    ...
    def __init__(self, platform, log_mode, generate_per_node_id_binary=False, quiet=False):
    ...
    def build_arguments(self, a):
        ...
        try:
            ...
            raise RuntimeError(f"Unknown testbed log mode {self.log_mode}. Available: {LOG_MODES.keys()}")
