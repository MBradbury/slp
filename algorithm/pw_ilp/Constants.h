...
#define NORMAL_ROUTE_FROM_SINK_DISTANCE_LIMIT 5

#define RTX_ATTEMPTS 30
#define BAD_NEIGHBOUR_THRESHOLD 9
#define BAD_NEIGHBOUR_DO_SEARCH_THRESHOLD 15
...
enum ApplicationSLPEvents
{
    ...
    ILPROUTING_OVERWRITING_QUEUED_NORMAL = 3003,
};

enum GenericMetrics
{
    METRIC_GENERIC_TIME_TAKEN_TO_SEND = 1,
    METRIC_GENERIC_NEXT_NORMAL_DELAY = 2,
};
