...
generic module TossimFaultModelP(uint8_t maximum_fault_point_types)
{
...
implementation
{
    ...
    command bool FaultModel.register_pair(uint8_t ident, const char* name)
    {
        ...
        {
            ERROR_OCCURRED(ERROR_FAULT_POINT_NAME_TOO_LONG, "The fault point %s is too long (%zu), please make it shorter than %u.\n",
        ...
        {
            ERROR_OCCURRED(ERROR_TOO_MANY_FAULT_POINT_TYPES, "Not enough room for %s, Please increase the size of FaultModelC.\n", name);
            return FALSE;
        }
    }
