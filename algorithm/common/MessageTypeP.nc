...
#ifdef SLP_DEBUG
		ERROR_OCCURRED(ERROR_UNKNOWN_MESSAGE_TYPE, "Unable to convert message name %s", name);
#endif
...
#ifdef SLP_DEBUG
		ERROR_OCCURRED(ERROR_UNKNOWN_MESSAGE_TYPE, "Unknown message type %" PRIu8, ident);
#endif
