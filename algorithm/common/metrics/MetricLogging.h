...
#define METRIC_BCAST(TYPE, STATUS, ULTIMATE_SOURCE, SEQUENCE_NUMBER, TX_POWER) \
	call MetricLogging.log_metric_bcast(#TYPE, STATUS, ULTIMATE_SOURCE, SEQUENCE_NUMBER, TX_POWER)

#define METRIC_DELIVER(TYPE, TARGET, PROXIMATE_SOURCE, ULTIMATE_SOURCE, SEQUENCE_NUMBER, RSSI, LQI) \
	call MetricLogging.log_metric_deliver(#TYPE, TARGET, PROXIMATE_SOURCE, ULTIMATE_SOURCE, SEQUENCE_NUMBER, RSSI, LQI)

#define ATTACKER_RCV(TYPE, MSG, PROXIMATE_SOURCE, ULTIMATE_SOURCE, SEQUENCE_NUMBER, RSSI, LQI) \
	call MetricLogging.log_attacker_receive(#TYPE, MSG, PROXIMATE_SOURCE, ULTIMATE_SOURCE, SEQUENCE_NUMBER, RSSI, LQI)
