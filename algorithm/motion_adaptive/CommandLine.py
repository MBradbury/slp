...
motion_adaptive = __import__(__package__, globals(), locals(), ['object'], -1)
...
class CLI(CommandLineCommon.CLI):
    ...
    def _execute_runner(self, driver, results_directory, skip_completed_simulations=True):
        ...
        runner = motion_adaptive.Runner.RunSimulations(driver, results_directory, safety_periods, skip_completed_simulations)
        runner.run(
