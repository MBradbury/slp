...
class Analyzer(AnalyzerCommon):
    def __init__(self, results_directory):
        ...
        d['src change detected'] = lambda x: self._format_results(x, 'SourceChangeDetected')
        d['detected src change'] = lambda x: self._format_results(x, 'NodesDetectedSrcChange')
