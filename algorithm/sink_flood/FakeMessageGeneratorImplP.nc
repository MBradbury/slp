...
implementation
{
	...
	command void FakeMessageGenerator.start(const AwayMessage* original)
	{
	...
	command void FakeMessageGenerator.startLimited(const AwayMessage* original, uint32_t duration_ms)
	{
	...
	command void FakeMessageGenerator.startRepeated(const AwayMessage* original, uint32_t duration_ms)
	{
		call FakeMessageGenerator.start(original);
